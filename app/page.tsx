    ...
    <main className="min-h-screen bg-white font-sans text-gray-900 scroll-smooth">
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="prose prose-lg text-gray-600">
            <p className="leading-relaxed mb-6">
              Buraya eğitim bilgileriniz, uzmanlık aldığınız kurumlar, akademik unvanlarınızı aldığınız yıllar ve çalıştığınız üniversiteler ile ilgili biyografik metinler gelecektir.
            </p>
            <p className="leading-relaxed">
              Örnek: "1980 yılında İstanbul Üniversitesi Cerrahpaşa Tıp Fakültesi'nden mezun oldu. Aynı kurumda İç Hastalıkları ve Endokrinoloji ihtisasını tamamladı. Ulusal ve uluslararası birçok kongrede oturum başkanlığı yapmış, sayısız panelde konuşmacı olarak yer almıştır."
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2 text-sm leading-relaxed">Diyabet alanında yaptığı uluslararası düzeydeki çalışmalar nedeniyle bu ödüle layık görülmüştür.</p>
              </div>
            </div>
             <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex gap-4 items-start opacity-60">
                <div className="bg-gray-100 text-gray-400 p-3 rounded-full flex-shrink-0">
                   <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                </div>
                <div>
                   <h3 className="font-bold text-lg text-gray-500">Diğer Ödüller Eklenecek</h3>
                   <p className="text-gray-400 mt-2 text-sm">Bilgiler geldiğinde bu alan yeni ödüllerle çoğaltılacaktır.</p>
                </div>
             </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-blue-600 pl-6 py-2">
              <h3 className="font-bold text-xl text-gray-900 mb-2">Makaleler (SCI & SCI-Expanded)</h3>
              <p className="text-gray-600 mb-4">Uluslararası hakemli dergilerde yayımlanan 100'den fazla makale buraya liste veya tablo şeklinde eklenecektir.</p>
              <a href="#" className="text-blue-600 font-semibold hover:underline text-sm inline-flex items-center">
                 Tüm Yayın Listesini İncele 
                 <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
              </a>
            </div>
            <div className="border-l-4 border-gray-300 pl-6 py-2 mt-8">
              <h3 className="font-bold text-xl text-gray-900 mb-2">Yazılan Kitaplar & Bölümler</h3>
              <p className="text-gray-600">Diyabet ve Metabolizma üzerine yazılmış tıbbi referans kitapları ve hasta eğitim rehberleri buraya kapak fotoğraflarıyla eklenebilir.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="longevity" className="py-20 md:py-24 bg-blue-50">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto mb-10">
            Hastalıkları tedavi etmenin ötesinde, sağlıklı ömrü uzatmak (Longevity) modern tıbbın en önemli hedeflerinden biridir. 
            Hücresel düzeyde metabolizmayı destekleyen bilimsel protokoller ve yaşam tarzı değişiklikleri ile kaliteli bir yaşlanma süreci yönetilebilir.
          </p>
          <div className="inline-flex items-center justify-center bg-white px-8 py-4 rounded-full shadow-md text-blue-800 font-bold border border-blue-100">
            İçerik Hazırlanıyor...
          </div>
        </div>
      </section>
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-8 md:space-y-10">
              <div className="flex gap-4 md:gap-5 items-center">
                <div className="bg-blue-100 p-3 md:p-4 rounded-full text-blue-600 flex-shrink-0">
                ...
                <div>
                  <p className="text-xs md:text-sm text-gray-500 uppercase font-bold tracking-widest mb-1">Klinik Telefon</p>
                  <p className="text-xl md:text-2xl font-extrabold text-gray-900">{siteData.personal.phone}</p>
                </div>
              </div>

              <div className="flex gap-4 md:gap-5 items-center">
                <div className="bg-green-100 p-3 md:p-4 rounded-full text-green-600 flex-shrink-0">
                ...
                <div>
                  <p className="text-xs md:text-sm text-gray-500 uppercase font-bold tracking-widest mb-1">WhatsApp Rezervasyon</p>
              ...
              <div className="flex gap-4 md:gap-5 items-start">
                <div className="bg-gray-100 p-3 md:p-4 rounded-full text-gray-600 flex-shrink-0 mt-1">
                  <svg className="w-6 h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                </div>
                <div>
                  <p className="text-xs md:text-sm text-gray-500 uppercase font-bold tracking-widest mb-1">Klinik Adresi</p>
      ...
      <footer className="bg-blue-900 text-white py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-lg md:text-xl font-bold mb-3">{siteData.personal.name}</p>
          <p className="text-blue-200 text-xs md:text-sm opacity-90 max-w-md mx-auto leading-relaxed px-4">
            ...
            Bu web sitesinde yer alan bilgiler bilgilendirme amaçlı olup, tıbbi tavsiye niteliği taşımamaktadır.
          </p>
        </div>
      </footer>
    </main>
